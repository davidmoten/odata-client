...
public final class Generator {
    ...
    private void writePatchedClass(EntityType t, String simpleClassName, Imports imports,
            Indent indent, PrintWriter p) {
        p.format("\n%spublic static final class %s extends %s implements %s<%s> {\n", indent,
                CLASS_NAME_PATCHED, simpleClassName, imports.add(Patchable.class), simpleClassName);
