...
public final class Names2 {
    ...
    private Names2(Schema schema, Options options) {
        this.schema = schema;
    ...
    // factory method
    public static Names2 clearOutputDirectoryAndCreate(Schema schema, Options options) {
        Names2 names = new Names2(schema, options);
