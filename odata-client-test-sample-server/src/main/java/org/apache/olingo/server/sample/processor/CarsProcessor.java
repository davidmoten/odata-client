...
public class CarsProcessor implements EntityCollectionProcessor, EntityProcessor,
    ...
    @Override
    public void readEntityCollection(final ODataRequest request, ODataResponse response,
        ...
        InputStream serializedContent = serializer.entityCollection(edm,
    ...
    public void readEntity(final ODataRequest request, ODataResponse response,
        ...
        if (entity == null) {
            ...
            final ExpandOption expand = uriInfo.getExpandOption();
            final SelectOption select = uriInfo.getSelectOption();
            InputStream serializedContent = serializer.entity(edm, edmEntitySet.getEntityType(),
                    entity,
    ...
    @Override
    public void readComplex(ODataRequest request, ODataResponse response, UriInfo uriInfo,
            ContentType format) throws ODataApplicationException, SerializerException {
            ...
            if (property == null) {
                ...
                if (property.getValue() == null) {
                    ...
                    InputStream serializerContent = complex
                            ? serializer
                                    .complex(edm, (EdmComplexType) edmProperty.getType(), property,
    ...
    private Entity readEntityInternal(final UriInfoResource uriInfo, final EdmEntitySet entitySet)
        ...
        final UriResourceEntitySet resourceEntitySet = (UriResourceEntitySet) uriInfo
    ...
    @Override
    public void deletePrimitiveValue(final ODataRequest request, ODataResponse response,
    ...
    @Override
    public void deleteComplex(final ODataRequest request, final ODataResponse response,
