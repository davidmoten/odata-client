...
public class CarsEdmProvider extends CsdlAbstractEdmProvider {
    ...
    public static final FullQualifiedName CONTAINER_FQN = new FullQualifiedName(NAMESPACE,
            CONTAINER_NAME);

    // Entity Types Names
    public static final FullQualifiedName ET_CAR = new FullQualifiedName(NAMESPACE, "Car");
    public static final FullQualifiedName ET_MANUFACTURER = new FullQualifiedName(NAMESPACE,
            "Manufacturer");
        ...
        if (ET_CAR.equals(entityTypeName)) {
            return new CsdlEntityType().setName(ET_CAR.getName())
                    ...
                    .setNavigationProperties(Arrays.asList(new CsdlNavigationProperty()
                            .setName("Manufacturer").setType(ET_MANUFACTURER)));
            ...
            return new CsdlEntityType().setName(ET_MANUFACTURER.getName())
                    ...
                    .setNavigationProperties(Arrays.asList(new CsdlNavigationProperty()
                            .setName("Cars").setType(ET_CAR).setCollection(true)));
        }
    ...
    public CsdlComplexType getComplexType(final FullQualifiedName complexTypeName)
        ...
        if (CT_ADDRESS.equals(complexTypeName)) {
            return new CsdlComplexType().setName(CT_ADDRESS.getName())
                    .setProperties(Arrays.asList(
    ...
    public CsdlEntitySet getEntitySet(final FullQualifiedName entityContainer,
        ...
        if (CONTAINER_FQN.equals(entityContainer)) {
            if (ES_CARS_NAME.equals(entitySetName)) {
                return new CsdlEntitySet().setName(ES_CARS_NAME).setType(ET_CAR)
                        .setNavigationPropertyBindings(Arrays
                                .asList(new CsdlNavigationPropertyBinding().setPath("Manufacturer")
                                        .setTarget(CONTAINER_FQN.getFullQualifiedNameAsString()
                ...
                return new CsdlEntitySet().setName(ES_MANUFACTURER_NAME).setType(ET_MANUFACTURER)
                        .setNavigationPropertyBindings(
                                Arrays.asList(new CsdlNavigationPropertyBinding().setPath("Cars")
                                        .setTarget(CONTAINER_FQN.getFullQualifiedNameAsString()
                                                + "/" + ES_CARS_NAME)));
            }
        }
