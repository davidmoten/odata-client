...
public class DataProvider {
            ...
            try {
                for (final Entity entity : entitySet.getEntities()) {
                    ...
                    for (final UriParameter key : keys) {
                        final EdmProperty property = (EdmProperty) entityType
                                .getProperty(key.getName());
    ...
    private EntityCollection createCars() {
        ...
        el = new Entity().addProperty(createPrimitive("Id", 3))
        ...
        el = new Entity().addProperty(createPrimitive("Id", 4))
        ...
        el = new Entity().addProperty(createPrimitive("Id", 5))
    ...
    private Property createAddress(final String street, final String city, final String zipCode,
